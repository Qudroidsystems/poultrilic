...
Route::group(['middleware' => ['auth']], function () {
    ...
    //Route::resource('weeks', WeekEntryController::class);
    // Route::get('weeks/{week}/daily/create', [DailyEntryController::class, 'create'])->name('daily.create');
    // Route::post('weeks/{week}/daily', [DailyEntryController::class, 'store'])->name('daily.store');
    // Route::get('analytics/dashboard', [AnalyticsController::class, 'dashboard'])->name('analytics.dashboard');
    // Route::get('flock/{flock}/report', [PDFController::class, 'report'])->name('flock.report');
