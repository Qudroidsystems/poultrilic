...
@section('content')
                                    ...
                                    <div class="tab-pane fade show active" id="mission">
                                        <div class="content-box-gap">
                                            ...
                                            <div class="avatar-box d-flex align-items-center">
                                                <div class="thumb">
                                                    <img src="{{ asset('website/assets/images/user-1.jpg')}}" alt="Admin Thumb">
                                                </div>
                                                <div class="content">
                                                    <img src="{{ asset('website/assets/images/sign-1.png')}}" alt="Sign">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="about-one_image-box p-r mb-50 pl-100">
                            <div class="about-img_one wow fadeInLeft">
                                <img src="{{ asset('website/assets/images/about/img-1.jpg')}}" alt="About Image">
                            </div>
                            <div class="about-img_two wow fadeInRight">
                                <img src="{{ asset('website/assets/images/about/img-2.jpg')}}" alt="About Image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="projects-slider-one">
                    ...
                    <div class="project-item wow fadeInDown">
                        <div class="img-holder">
                            <img src="{{ asset('website/assets/images/portfolio/img-2.jpg')}}" alt="Gallery Image">
                            <div class="hover-portfolio">
                                <div class="hover-content">
                                    <h3 class="title"><a href="portfolio-details.html">Golder Wheat</a></h3>
                                    <p><a href="#">Agriculture</a>,<a href="#">Foods</a></p>
                    ...
                    <div class="project-item wow fadeInUp">
                        <div class="img-holder">
                            <img src="{{ asset('website/assets/images/portfolio/img-3.jpg')}}" alt="Gallery Image">
                            <div class="hover-portfolio">
                                <div class="hover-content">
                                    <h3 class="title"><a href="portfolio-details.html">Golder Wheat</a></h3>
                                    <p><a href="#">Agriculture</a>,<a href="#">Foods</a></p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4">
                        <div class="single-service-item mb-50 wow fadeInUp">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-1.png')}}" alt="Icon">
                            </div>
                            <div class="text">
                        ...
                        <div class="single-service-item mb-50 wow fadeInDown">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-2.png')}}" alt="Icon">
                            </div>
                            <div class="text">
                        ...
                        <div class="single-service-item mb-50 wow fadeInUp">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-3.png')}}" alt="Icon">
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-4">
                        <div class="img-holder mb-50 wow fadeInDown">
                            <img src="{{ asset('website/assets/images/service/img-1.jpg')}}" alt="Service Image">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-service-item mb-50 card-rtl wow fadeInDown">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-4.png')}}" alt="Icon">
                            </div>
                            <div class="text">
                        ...
                        <div class="single-service-item mb-50 card-rtl fadeInUp">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-5.png')}}" alt="Icon">
                            </div>
                            <div class="text">
                        ...
                        <div class="single-service-item mb-50 card-rtl wow fadeInDown">
                            <div class="icon">
                                <img src="{{ asset('website/assets/images/icon/icon-6.png')}}" alt="Icon">
                            </div>
                            <div class="text">
        ...
        <section class="offer-section-one p-r z-2">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="offer-one_image-box bg_cover mb-50 wow fadeInRight" style="background-image: url({{ asset('website/assets/images/bg/offer-bg-1.jpg')}});">
                ...
                <div class="testimonial-slider-one">
                    <div class="testimonial-item text-center wow fadeInDown">
                        <div class="author-thumb">
                            <img src="{{ asset('website/assets/images/testimonial/img-1.jpg')}}" alt="author Image">
                        </div>
                    ...
                    <div class="testimonial-item text-center wow fadeInUp">
                        <div class="author-thumb">
                            <img src="{{ asset('website/assets/images/testimonial/img-2.jpg')}}" alt="author Image">
                        </div>
                        <div class="testimonial-content">
                            <p>“Sit amet consectetu escing elit sed do eiusmod tempor incididunt ut labore dolore magna aliqua. Quis ipsum suspendisse ultrices gravic darisus comoe” </p>
                            <div class="quote"><i class="fas fa-quote-right"></i></div>
                    ...
                    <div class="testimonial-item text-center wow fadeInDown">
                        <div class="author-thumb">
                            <img src="{{ asset('website/assets/images/testimonial/img-3.jpg')}}" alt="author Image">
                        </div>
                        <div class="testimonial-content">
                            <p>“Sit amet consectetu escing elit sed do eiusmod tempor incididunt ut labore dolore magna aliqua. Quis ipsum suspendisse ultrices gravic darisus comoe” </p>
                            <div class="quote"><i class="fas fa-quote-right"></i></div>
                    ...
                    <div class="testimonial-item text-center wow fadeInUp">
                        <div class="author-thumb">
                            <img src="{{ asset('website/assets/images/testimonial/img-4.jpg')}}" alt="author Image">
                        </div>
                        <div class="testimonial-content">
                            <p>“Sit amet consectetu escing elit sed do eiusmod tempor incididunt ut labore dolore magna aliqua. Quis ipsum suspendisse ultrices gravic darisus comoe” </p>
                            <div class="quote"><i class="fas fa-quote-right"></i></div>
        ...
        <section class="contact-one p-r z-2">
            <div class="container-fluid">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-one_information-box bg_cover wow fadeInRight" style="background-image: url({{ asset('website/assets/images/bg/contact-bg-1.jpg')}});">
                    ...
                    <div class="col-lg-12">
                        <div class="blog-post-item-one mb-30 wow fadeInLeft">
                            <div class="post-thumbnail">
                                <img src="{{ asset('website/assets/images/blog/img-1.jpg')}}" alt="Post Image">
                            </div>
                        ...
                        <div class="blog-post-item-one mb-30 wow fadeInRight">
                            <div class="post-thumbnail">
                                <img src="{{ asset('website/assets/images/blog/img-2.jpg')}}" alt="Post Image">
                            </div>
                            <div class="entry-content">
                                <a href="#" class="cat-btn">Organic Foods</a>
                        ...
                        <div class="blog-post-item-one mb-30 wow fadeInLeft">
                            <div class="post-thumbnail">
                                <img src="{{ asset('website/assets/images/blog/img-3.jpg')}}" alt="Post Image">
                            </div>
                            <div class="entry-content">
                                <a href="#" class="cat-btn">Organic Foods</a>
                                <h3 class="title"><a href="#">Smashing Podcast Episode 44 With Chris 
                ...
                <div class="partner-slider-one wow fadeInDown">
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-1.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-2.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-3.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-4.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-5.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
                            <img src="{{ asset('website/assets/images/partner/img-6.png')}}" alt="partner image">
                        </div>
                    </div>
                    <div class="partner-item">
                        <div class="partner-img">
